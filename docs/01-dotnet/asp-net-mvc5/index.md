...
> **Legacy to Modern**: 현재 실무에서 운용 중인 ASP.NET MVC 5 레거시 프로젝트의 심층 분석과 안정적인 리팩토링을 위한 학습 아카이브입니다.
...
| 도서명 | 핵심 키워드 | 링크 |
| :--- | :--- | :--- |
| **Pro ASP.NET MVC 5 (아담 프리먼 저)** | `MVC 5` `기초` `패턴` `단위 테스트` | [알라딘 중고정보](https://www.aladin.co.kr/search/wsearchresult.aspx?SearchTarget=Used&SearchWord=Pro+ASP.NET+MVC+5) |
...
> - **이유**: 레거시 소스 리팩토링 프로젝트 우선순위 배정.
> - **향후 계획**: 실무 소스 리팩토링 진행 과정에서 발생하는 이슈와 해결 방안을 중심으로 실무 지식 위주 업데이트 예정.
